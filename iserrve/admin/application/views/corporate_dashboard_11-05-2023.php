...
$this->load->library('Need_lib');
				  ...
				  $lib2 = $this->need_lib->downloaded_Ecard($policy_data->policy_no,$enrolement_att_data->employee_id);
		
		/* echo "<pre>";print_r($lib2);echo "</pre>";
					...
					<tr>
                        ...
                        if($ecard_data != 0){
                           ...
                           if($ecard_data->pdf_file != ''){ ?>
                             ...
                             <!-- <a href="<?php echo base_url().'ecards/download_card/'.$ecard_data->pdf_file.'/'.$policy_data->policy_no; ?>" class="btn bg-purple2">Download</a>-->
