    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);">Edit User Escalation</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>user_escalation/lists">User Escalation</a></li>
                    <li class="crumb-trail">Edit User Escalation</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Edit User Escalation </span> </div>
  ...
  { ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>user_escalation/edit/<?php echo $id; ?>"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_user_escalation">

                                    <div class="form-group">
                                        <label for="name">Full Name <span class="mandatory_field">*</span></label>
                                        <input id="name" name="name" type="text" class="form-control"
                                            placeholder="Enter Full Name" value="<?php echo $name; ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="alternate_email" name="alternate_email" type="email" class="form-control"
                                            placeholder="Enter Alternate Email ID" value="<?php echo $alternate_email; ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Full address of Respective Company </label>
                                        <input id="address" name="address" type="text" class="form-control"
                                            placeholder="Enter Full address of Respective Company" value="<?php echo $address; ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="type" name="type" class="form-control">
                                            ...
                                            <option value="TPA" <?php if($type == 'TPA'){echo "selected";}?>>TPA</option>
                                            <option value="BROKER" <?php if($type == 'BROKER'){echo "selected";}?>>BROKER</option>
                                        </select>
                                    </div>
