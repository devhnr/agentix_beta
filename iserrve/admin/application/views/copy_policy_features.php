    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Copy Policy Features </a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>policy_features/lists">Policy Features</a></li>
                    <li class="crumb-trail">Copy Policy Features</li>
                </ol>
            </div>
        </div>
        <div id="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span>Copy Policy Features</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>policy_features/copy_policy_fet/<?php echo $id; ?>"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="copy_policy_fet">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="corporate_id" name="corporate_id_old"
                                            class="form-control" onChange="showpolicy(this.value)" disabled>
                                   ...
                                   <div class="form-group" style="display:none;">
                                    ...
                                    <div class="form-group rfa_multiple_select">
                                        ...
                                        <select id="policy_no" name="policy_no" class="form-control multiple-select" onChange="showproduct_name(this.value)">
                                            ...
                                            <?php  if($allpolicy_using_corporate !='' && count($allpolicy_using_corporate) > 0){ 
                                                //echo "<pre>";print_r($product_type);echo "</pre>";

                                            foreach($allpolicy_using_corporate as $policy_no_data){
                                            $product_type_id = $this->policy_features_model->get_product_type_id($policy_no_data->product_type); 
                                            echo "<pre>";print_r($product_type_id);echo "</pre>";
                                            if ($product_type_id->id == $product_type) {
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="product_type" name="product_type_old"
                                            class="form-control" onChange="show_form_data(this.value)" disabled>
                                            <option value="">Select Product Type</option>
                                            <?php if ($allproduct_type_new != '' && count($allproduct_type_new) > 0) {
                                                foreach ($allproduct_type_new as $allproduct_type_data) {
                                                    ?>
                                            <option value="<?php echo $allproduct_type_data->id; ?>" <?php if($allproduct_type_data->id == $product_type){echo "selected";}?>><?php echo $allproduct_type_data->name; ?>
                                            </option>
                                            <?php } } ?>
                                        </select>
										</span>
                                    ...
                                    <div class="form_fill_data" id="form_fill_data">
                                        <?php
                                            $get_form_field = $this->policy_features_model->get_form_field($product_type);
                                            
                                            //echo "<pre>";print_r($get_form_field);echo"</pre>";

                                            foreach($get_form_field as $get_form_field_data){

                                                $answer_data = $this->policy_features_model->get_answer_data($id,$get_form_field_data->id); 
                                            ...
                                            <input type="hidden" name="updateid1xxx[]" id="updateid1xxx<?php echo $i + 1; ?>"
                                                                                    value="<?php echo $answer_data->id; ?>">

                                                    <div class="form-group">
                                                        <label for="inclusions" style="margin:15px 6px 5px 0px; "><?php echo $get_form_field_data->label_name; ?></label>

                                                        <input type="checkbox" name="checkboxu[]" id="checkbox_<?php echo $get_form_field_data->id ?>" value="<?php echo $answer_data->status; ?>" onclick="check_box_click('<?php echo $get_form_field_data->id ?>',this);" <?php if($answer_data->status == 1){echo "checked";}?>>

                                                        <input type="hidden" name="checkbox_hiddenu[]" id="checkbox_hidden_<?php echo $get_form_field_data->id?>" value="<?php echo $answer_data->status; ?>" >

                                                        <input type="hidden" name="field_idu[]" id="field_id" value="<?php echo $get_form_field_data->id; ?>" class="form-control" >

                                                        <input type="text" name="field_typeu[]" id="field_type" class="form-control"  placeholder="Enter <?php echo $get_form_field_data->label_name; ?>" value= "<?php echo $answer_data->field_type;?>">

                                                    </div>

                                                <?php } ?>

                                                <?php if($get_form_field_data->type == 2){ // textarea ?>
                                        ...
                                        value="<?php echo $answer_data->id; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="field_typeu" name="field_typeu[]" class="form-control"
						                                    placeholder="Enter <?php echo $get_form_field_data->label_name; ?>"><?php echo $answer_data->field_type;?></textarea>

                                                    </div>

                                                <?php } ?>

                                                <?php if($get_form_field_data->type == 3){ // select 
...
<input type="hidden" name="updateid1xxx[]" id="updateid1xxx<?php echo $i + 1; ?>"
                                        value="<?php echo $answer_data->id; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="field_type" name="field_typeu[]" class="form-control" >
                                                        <option value="">Select <?php echo $get_form_field_data->label_name ?></option>

                                                        <?php foreach($form_field_attribute as $form_field_attribute_data){?>
                                                            <option value="<?php echo $form_field_attribute_data->id?>" <?php if($form_field_attribute_data->id == $answer_data->field_type){echo "selected";}?>><?php echo $form_field_attribute_data->option_name ?></option>
                                                ...
                                                <?php if($get_form_field_data->type == 4){ // Radio 
                                                    ...
                                                    //echo "<pre>";print_r($form_field_attribute);echo"</pre>";
                                                    ?>

<input type="hidden" name="updateid1xxx_radio[]" id="updateid1xxx<?php echo $i + 1; ?>"
                                        value="<?php echo $answer_data->id; ?>">
													...
													<div class="col-md-3">
                                                        ...
                                                        <input type="checkbox" name="checkbox_radiou[]" id="checkbox_<?php echo $get_form_field_data->id ?>" value="<?php echo $answer_data->status; ?>" onclick="check_box_click('<?php echo $get_form_field_data->id ?>',this);" <?php if($answer_data->status == 1){echo "checked";}?>><br>

                                                        <input type="hidden" name="checkbox_radio_hiddenu[]" id="checkbox_hidden_<?php echo $get_form_field_data->id?>" value="<?php echo $answer_data->status; ?>" >


                                                        <input type="hidden" name="field_id_radiou[]" id="field_id" value="<?php echo $get_form_field_data->id; ?>" class="form-control" >

                                                        <?php foreach($form_field_attribute as $form_field_attribute_data){ ?>

                                                        <input type="radio" id="html" name="radio_<?php echo $form_field_attribute_data->form_field_id ?>" value="<?php echo $form_field_attribute_data->option_name ?>" <?php if($form_field_attribute_data->option_name == $answer_data->field_type){echo "checked";}?> onclick="radio_hide_show_Attrdiv('<?php echo $get_form_field_data->id ?>',this.value);">
                                                        <label><?php echo $form_field_attribute_data->option_name;?></label>
													...
													<div class="col-md-9">
														<div id="hide_radio_attr<?php echo $get_form_field_data->id?>"  style="<?php if($display == 1){echo "display:block";}else{echo "display:none";}?>">
														
															<?php $radio_attribute = $this->policy_features_model->radio_attribute($get_form_field_data->id);
																
																$answer_data_radio_att = $this->policy_features_model->get_answer_data_radio_att($id,$get_form_field_data->id);
																	...
																	if($radio_attribute != ''){
																		...
																		foreach($radio_attribute as $radio_attribute_data){
																			...
																			//echo $sd;
																			//echo "<pre>";print_r($answer_data_radio_att[$sd]);echo"</pre>";
																			
																			
																			//echo "<pre>";print_r($answer_data_radio_att);echo"</pre>";
															?>
															
																<input type="hidden" name="updateid1xxx_radio_att[]" id="updateid1xxx<?php echo $i + 1; ?>"
                                        value="<?php echo $answer_data_radio_att[$sd]->id; ?>">


                                        <?php if($radio_attribute_data->type == 1){ ?>
															
                                            <div class="form-group"  style="width: 20%;display: inline-block;margin-left:15px">
                                                
                                                <label for="inclusions" style="margin:15px 6px 5px 0px;"><?php echo $radio_attribute_data->label_name ?></label>
                                                
                                                <input type="checkbox" name="checkbox_radio_attu[]" id="checkbox_<?php echo $radio_attribute_data->id ?>" onclick="check_box_radio_att_click('<?php echo $radio_attribute_data->id?>',this);" value="<?php echo $answer_data_radio_att[$sd]->status; ?>" <?php if($answer_data_radio_att[$sd]->status == 1){echo "checked";}?>><br>
                                                
                                                <input type="hidden" name="checkbox_radio_att_hiddenu[]" id="checkbox_radio_att_hidden_<?php echo $radio_attribute_data->id ?>" value="<?php echo $answer_data_radio_att[$sd]->status; ?>" >
                                                ...
                                                <input type="hidden" name="field_id_radio_attu[]" id="field_id_radio_attu" value="<?php echo $get_form_field_data->id ?>" class="form-control" >
                                                
                                                <input type="text" name="field_type_radio_attu[]" id="field_type_radio_attu_<?php echo $get_form_field_data->id ?>" class="form-control field_type_radio_attu_<?php echo $get_form_field_data->id ?>"  placeholder="Enter <?php echo $radio_attribute_data->label_name ?>" value="<?php echo $answer_data_radio_att[$sd]->field_type;?>">
                                            
                                            </div>

                                            <?php } if($radio_attribute_data->type == 2){?>
                                                ...
                                                <textarea id="field_type" name="field_type_radio_attu[]" class="form-control field_type_radio_attu_<?php echo $get_form_field_data->id ?>"
						placeholder="Enter <?php echo $radio_attribute_data->label_name ?>"><?php echo $answer_data_radio_att[$sd]->field_type;?></textarea>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <textarea id="inclusions" name="inclusions" class="form-control"
                                            placeholder="Enter Inclusions"><?php echo $inclusions; ?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <textarea id="exclusions" name="exclusions" class="form-control"
                                            placeholder="Enter Exclusions"><?php echo $exclusions; ?></textarea>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>policy_features/lists" class="submit btn bg-purple pull-right" style="margin-right: 10px;" />Cancel</a>
                            </div>
