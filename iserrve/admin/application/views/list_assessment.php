...
<!-- Start: Main --><div id="main">
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">Assessment</a></li>
...
<?php } ?>
 ...
 <span class="glyphicon glyphicon-list-alt"></span>Assessment Listing </span>
         ...
         if (checkbox.length > 0) {
             ...
             if (conf == true) {
                 $.ajax({
                     ...
                     method: "POST",
                     data: {checkbox_value: checkbox_value, tbl : 'tbl_assessment'},
                     success: function() {
                       var base_url = '<?php echo $base_url.'home/assessment_list'; ?>';
