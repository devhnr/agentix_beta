    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit Policy Features </a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>policy_features/lists">Policy Features</a></li>
                    <li class="crumb-trail">Edit Policy Features</li>
                </ol>
            </div>
        </div>
        <div id="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Policy Features</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>policy_features/edit/<?php echo $id; ?>"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_policy_features">
...
<input type="hidden" name="updateid1xxx_radio[]" id="updateid1xxx<?php echo $i + 1; ?>"
						...
						placeholder="Enter <?php echo $radio_attribute_data->label_name ?>"><?php echo $answer_data_radio_att[$sd]->field_type;?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>policy_features/lists" class="submit btn bg-purple pull-right"
