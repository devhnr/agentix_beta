         ...
         <div class="topbar-left">
            <ol class="breadcrumb">
               <li class="crumb-active">
                  <a href="javascript:void(0);">IVF Form</a>
               </li>
               <li class="crumb-icon"><a href="<?php echo $base_url; ?>">
                  <span class="glyphicon glyphicon-home"></span></a>
               </li>
               <li class="crumb-trail">IVF Form</li>
            </ol>
         </div>
      </div>
      ...
      <div id="content">
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <a href="<?php echo $base_url;?>slider_get_quote/createExcel" class="btn btn-alert pull-right"> Download Excel</a>
            ...
            <div class="col-md-12">
               <div class="panel">
                  <div class="panel-heading">
                     ...
                     <span class="glyphicon glyphicon-list-alt"></span>IVF Form Listing </span>
                  </div>
                           ...
                           <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $result[$i]->services; ?></td>
