                                ...
                                <textarea id="advantage_desc" name="advantage_desc" class="form-control"
                                    ...
                                    $k = 0;
                                     if ($advantage_group_ins != '') { ?>
                                        ...
                                        <input type="hidden" name="for_employee1[]" value="">
                                    ...
                                    <div class="col-md-12 ">
                                         ...
                                         <div class="col-md-10">
                                            ...
                                            <input type="radio" id="for_employeeu<?php echo $i + 1; ?>" name="for_employeeu[]<?php echo $k; ?>" 
                                                placeholder="Enter Name" value="1" <?php if($advantage_group_ins[$i]->for_employee == 1){echo "checked";}?>/>&nbsp;&nbsp;For Employer &nbsp;&nbsp;

                                            <input type="radio" id="for_employeeu<?php echo $i + 1; ?>" name="for_employeeu[]<?php echo $k; ?>"
                                                placeholder="Enter Name" value="2" <?php if($advantage_group_ins[$i]->for_employee == 2){echo "checked";}?>/> For Employees
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="for_employee1" name="for_employee1[]" type="radio" value="1"/>&nbsp;&nbsp;For Employer &nbsp;&nbsp;

                                        <input id="for_employee1" name="for_employee1[]" type="radio" value="2" /> For Employees
                                    </div>
                                </div>
