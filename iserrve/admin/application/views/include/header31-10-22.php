...
<header class="navbar navbar-fixed-top">
  ...
  <span id="toggle_sidemenu_l" class="glyphicons glyphicons-show_lines"></span> <a class="navbar-brand" href="<?php echo $base_url;?>"><img alt="MSME Accelerate" src="<?php echo $base_url_views;?>images/logo_msmew.png" width="130px" height="50px" style="margin-top: 10px;"></a> </div>
