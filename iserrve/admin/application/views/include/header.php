...
<link rel="stylesheet" type="text/css" href="<?php echo $base_url_views;?>css/mediaBoxes.css">
<link rel="stylesheet" type="text/css" href="<?php echo $base_url_views;?>css/fSelect.css">
<!-- Favicon -->

<link rel="shortcut icon" href="<?php echo $base_url_views;?>images/favicon.ico">
...
<header class="navbar navbar-fixed-top">
  <div class="navbar-branding">
   <span id="toggle_sidemenu_l" class="glyphicons glyphicons-show_lines"></span> 
    ...
    <img alt="iSerrve" src="<?php echo $base_url_views;?>images/isserve.png" width="130px" height="50px" style="margin-top: 5px;"></a> 
  ...
  <div class="navbar-right w-auto text-right">
    <a  class="main-btn head-btn" href="<?php echo $base_url;?>welcome/logout">Sign Out</a>
    <!--div class="navbar-search">
      <input type="text" id="HeaderSearch" placeholder="Search..." value="Search...">
    </div
    <div class="navbar-menus">		<div class="btn-group">    <button title="Change Password" type="button" onclick="window.location='<?php //echo $base_url; ?>home/change_password'"><i class="fa fa-key"> Change Password</i></button>    </div>	<div class="btn-group">              </div>-->
