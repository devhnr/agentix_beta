...
<!-- Start: Main --><div id="main">   
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">Book Consultation</a></li>         

 <li class="crumb-icon"><a href="<?php echo $base_url; ?>">

 <span class="glyphicon glyphicon-home"></span></a></li>                   

 <li class="crumb-trail">Book Consultation</li>        
 ...
 <div class="col-md-12">		
  ...
  <a href="<?php echo $base_url;?>book_consultation/createExcel" class="btn btn-alert pull-right"> Download Excel</a>

  <!-- <form action="<?php echo $base_url."book_consultation/download_user";?>" method="post" enctype="multipart/form-data">
 ...
 <span class="glyphicon glyphicon-list-alt"></span>Book Consultation Listing </span> 

 </div>            <div class="panel-body">			  

 <form action="<?php echo $base_url."book_consultation/deletes";?>" method="post" enctype="multipart/form-data" id="form">			  
...
<!-- <td><?php //echo $this->book_consultation_model->get_productname($result[$i]->product_id);?></td> -->
...
<i class="fa fa-pencil"></i></a></td> -->					  
 ...
 <?php } } else {	 echo 'No Book Consultation Found';
