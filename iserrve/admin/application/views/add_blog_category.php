                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>blog_category/add"
                                    ...
                                    <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="name">Category Name <span class="mandatory_field">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="page_url">Page Url  <span class="mandatory_field">*</span></label>
