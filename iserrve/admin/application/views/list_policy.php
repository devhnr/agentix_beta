        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Policy</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Policy</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>policy/add/" class="btn btn-alert pull-right"><i
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Policy Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."policy/deletes";?>" method="post"
                  ...
                  if($result){
					...
					for($i=0;$i<count($result);$i++){
                        // echo "<pre>";print_r($result[$i]->corporate_id);echo "</pre>";

                        $corporate_data = $this->admin->get_corp_data_ac_de($result[$i]->corporate_id);
						
						$policy_data = $this->admin->get_policy_data($result[$i]->id);
						
						if($policy_data->policy_end_date >= date('Y-m-d')){
							$style="";
						}else{
							
							$style = 'style="background-color:#ffdede"';
						}
//echo "<pre>";print_r($policy_data);echo "</pre>";
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td <?php echo $style; ?>><input name="selected[]" id="selected[]"
                                                        value="<?php echo $result[$i]->id; ?>" type="checkbox"
                                                        class="minimal-red"></td>


                                                <td <?php echo $style; ?>> <?php echo $result[$i]->insurer; ?></td>

                                                <td <?php echo $style; ?>><?php echo $this->policy_model->get_corporate_name($result[$i]->corporate_id); ?></td> 

                                                <td <?php echo $style; ?>> <?php echo $result[$i]->policy_type; ?></td>

                                                <td <?php echo $style; ?>><?php echo $result[$i]->product_type; ?></td>

                                                <td <?php echo $style; ?>><?php echo $result[$i]->product_name; ?></td>

                                                <td <?php echo $style; ?>><?php echo $result[$i]->policy_no; ?></td>
                                                
                                                <td <?php echo $style; ?>><?php echo date("d-m-Y",strtotime($result[$i]->policy_start_date)); ?></td>

                                                <td <?php echo $style; ?>><?php echo date("d-m-Y",strtotime($result[$i]->policy_end_date)); ?></td>
                                              ...
                                              <!--   <td><img src="<?php echo $front_base_url.'/upload/policy_home/large/'.$result[$i]->home_image;?>" width="50" height="50" /></td> -->
                                             ...
                                             <!--    <td>
                                                ...
                                                <td <?php echo $style; ?>><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."policy/edit/"; ?><?php echo $result[$i]->id; ?>">
...
<!-- Modal -->
  <div class="modal fade" id="myModal_policy" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align:center;">
            ...
            <p class="model_success_p1">Policy Create Successfully</p>
            <p class="model_success_p2">Please Click On Next Button TO Create Sum Insured</p>
            <button type="button" class="btn btn-default" data-dismiss="modal">Stay Here</button>
            <a href="<?php echo $base_url;?>sum_insured/add/" class="btn btn-default">Next</a>
        </div>
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'policy/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>policy/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'policy/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of policy');

    if (t) {

        window.location.href = '<?php echo $base_url;?>policy/updateorder/' + id + '/' + val;
...
if($this->session->flashdata('L_strErrorMessage') == 'Policy Added Successfully') { ?>
    <script>
	//alert('<?php echo $this->session->userdata("product_type_name_session") ?>');
        $("#myModal_policy").modal('show');
    </script>
<?php } 
 //} ?>