    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit Endorsement Rack Rates </a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>endorsement_rack_rates/lists">Endorsement Rack Rates</a></li>
                    <li class="crumb-trail">Edit Endorsement Rack Rates</li>
                </ol>
            </div>
        </div>
        <div id="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Endorsement Rack Rates</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>endorsement_rack_rates/edit/<?php echo $id; ?>"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_endorsement_rack_rates">
								...
								<?php if ($addition_item != '') { ?>
										...
										<?php for ($i = 0; $i < count($addition_item); $i++) { ?>
											...
											<div class="col-md-12">
												...
												<div class="col-md-2">
													<div class="form-group">
														<label for="agefromu"> Age From <span class="mandatory_field">*</span></label>
														<input id="agefromu_<?php echo $addition_item[$i]->id; ?>" name="agefromu[]" type="number" class="form-control blank_val"
												...
												<div class="col-md-2">
													<div class="form-group">
														<label for="agetou"> Age To <span class="mandatory_field">*</span></label>
														<input id="agetou_<?php echo $addition_item[$i]->id; ?>" name="agetou[]" type="number" class="form-control blank_val"
												...
												<div class="col-md-2" id="rate_in_mili_section" style="display:none;">
													<div class="form-group">
														<label for="rate_in_miliu">Rate In Mili <span class="mandatory_field">*</span></label>
														<input id="rate_in_miliu_<?php echo $addition_item[$i]->id; ?>" name="rate_in_miliu[]" type="number" class="form-control blank_val"
												...
												<div class="col-md-2">
													<div class="form-group">
														<label for="annual_premiumu">Annual Premium <span class="mandatory_field">*</span></label>
														<input id="annual_premiumu_<?php echo $addition_item[$i]->id; ?>" name="annual_premiumu[]" type="number" class="form-control blank_val"
															placeholder="Enter Annual Premium" value="<?php echo $addition_item[$i]->annual_premium; ?>"/>
													</div>
												</div>
												
												<a href="#"
                                            onclick="singledelete('<?php echo $base_url . "endorsement_rack_rates/removeprice/"; ?><?php echo $addition_item[$i]->endorsement_rack_rates_id; ?>/<?php echo $addition_item[$i]->id; ?>');"
								...
								<div class="col-md-12" id="add_more_sec_for_gpa_gtl" style="display:none">
									...
									<div class="col-md-2">
                                        <div class="form-group">
                                            <label for="categoryname"> Age From <span class="mandatory_field">*</span></label>
                                            <input id="agefrom_0" name="agefrom[]" type="number" class="form-control blank_val_gpa_gtl"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="ageto"> Age To <span class="mandatory_field">*</span></label>
                                            <input id="ageto_0" name="ageto[]" type="number" class="form-control blank_val_gpa_gtl"
                                    ...
                                    <div class="col-md-2" id="rate_in_mili_section" >
                                        <div class="form-group">
                                            <label for="rate_in_mili">Rate In Mili <span class="mandatory_field">*</span></label>
                                            <input id="rate_in_mili_gpa_gtl_0" name="rate_in_mili[]" type="number" class="form-control blank_val_gpa_gtl"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="annual_premium">Annual Premium <span class="mandatory_field">*</span></label>
                                            <input id="annual_premium_gpa_gtl_0" name="annual_premium[]" type="number" class="form-control blank_val_gpa_gtl annual_premium"
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<a href="<?php echo $base_url;?>endorsement_rack_rates/lists" class="submit btn bg-purple pull-right"
...
function validate() {
    ...
    if (form.endorsement_type[0].checked == true|| form.endorsement_type[1].checked == true ){
        ...
        ?>
            var agefrom = $("#agefromu_<?php echo $addition_item[$i]->id?>").val();
            if (agefrom == '') {
            ...
            var ageto = $("#agetou_<?php echo $addition_item[$i]->id?>").val();
            if (ageto == '') {
            ...
            var annual_premium = $("#annual_premiumu_<?php echo $addition_item[$i]->id?>").val();
            if (annual_premium == '') {
        ...
        )
    {
        ...
        var rate_in_mili_gpa_gtl_0 = $("#rate_in_mili_gpa_gtl_0").val();
        if (rate_in_mili_gpa_gtl_0 == '') {
        ...
        var annual_premium_gpa_gtl_0 = $("#annual_premium_gpa_gtl_0").val();
        if (annual_premium_gpa_gtl_0 == '') {
            $("#error_msg1").html("Please Enter Annual Premium.");
            $("#validator").css("display", "block");
            $('html, body').animate({
                'scrollTop': $("#error_msg1").position().top
...
<script type = "text/javascript">
    ...
    function showproduct_insurer(pro_id){
        // alert(pro_id);exit;
        var url = '<?php echo $base_url; ?>endorsement_rack_rates/get_policy_insurer';
    ...
    function show_form_data(product_type_id){
        // alert(pro_id);exit;
        var url = '<?php echo $base_url; ?>endorsement_rack_rates/show_form_data';
...
$(document).ready(function() {
    $("#rate_in_mili_gpa_gtl_0").keyup(function() {
        var dInput = $(this).val();
        var suminsure = $('#suminsure_hidden').val()

        var total = dInput / 1000 * suminsure;

        $('#annual_premium_gpa_gtl_0').val(total.toFixed(2));
        //alert(total);
