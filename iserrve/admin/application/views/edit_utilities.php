   ...
   <section id="content_wrapper">
      <div id="topbar">
         <div class="topbar-left">
            <ol class="breadcrumb">
               <li class="crumb-active"><a href="javascript:void(0);"> Edit Utilities</a></li>
               <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                  class="glyphicon glyphicon-home"></span></a></li>
               <li class="crumb-link"><a href="<?php echo $base_url; ?>utilities/lists">Utilities</a></li>
               <li class="crumb-trail">Edit Utilities</li>
            </ol>
         </div>
      </div>
      <div id="content">
         <div class="row">
            <div class="col-md-12">
               <div class="panel">
                  <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Utilities</span> </div>
                  <div class="panel-body">
                     ...
                     <div class="col-md-12">
                        <form role="form" id="form" method="post"
                           action="<?php echo $base_url;?>utilities/edit/<?php echo $id; ?>"
                           enctype="multipart/form-data">
                           <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                           <INPUT TYPE="hidden" NAME="action" VALUE="edit_utilities">
                           ...
                           <div class="col-md-6">
                              <div class="form-group rfa_multiple_select">
                                 ...
                                 <select id="document_type" name="document_type" class="form-control multiple-select">
                                    ...
                                    <option value="<?php echo $alldocument_type_data->id; ?>" <?php if ($alldocument_type_data->id == $document_type) {
                                       echo "selected";
                                       } ?>><?php echo $alldocument_type_data->name; ?></option>
                                    <?php } }  ?>             
                                 </select>
                              </div>
                           </div>
                                 ...
                                 <select id="policy_type" name="policy_type" class="form-control multiple-select">
                                    ...
                                    <?php if ($allproduct_type_new != '' && count($allproduct_type_new) > 0) {
                                                foreach ($allproduct_type_new as $allproduct_type_data) {
                                                    ?>
                                            <option value="<?php echo $allproduct_type_data->id; ?>" <?php if($allproduct_type_data->id == $policy_type){echo "selected";}?>><?php echo $allproduct_type_data->name; ?>
                                            </option>
                                            <?php } } ?>      
                                 </select>
                                 </span>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <textarea name="note" id="note" class="form-control" placeholder="Enter Note"><?php echo $note;?></textarea>
                              </div>
                           </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <?php if($document != ''){?>
                                    <a target="_blank" href="<?php echo $front_base_url; ?>upload/utilities/<?php echo $document; ?>">View Document</a>
                                    <?php } ?>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <a href="<?php echo $base_url;?>utilities/lists" class="submit btn bg-purple pull-right"
