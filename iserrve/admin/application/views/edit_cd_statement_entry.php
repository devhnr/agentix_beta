        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit CD Statement Entry</a></li>
                    ...
                    <li class="crumb-trail">Edit CD Statement Entry</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    ...
                                    class="glyphicon glyphicon-lock"></span> Edit CD Statement Entry</span> </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>cd_statement_entry/edit/<?php echo $id; ?>" enctype="multipart/form-data">

                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_cd_statement_entry">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cd_number" name="cd_number" type="text" class="form-control"
                                            placeholder="Enter CD Number" value="<?php echo $cd_number; ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                       <label>CD Account Name <span class="mandatory_field">*</span></label>
                                       <input id="cd_account_name" name="cd_account_name" type="cd_account_name" class="form-control" placeholder="Enter CD Account Name" value="<?php echo $cd_account_name; ?>"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="particular" name="particular" type="text" class="form-control"
                                            placeholder="Enter Particular" value="" /><?php echo $particular; ?></textarea>
                                    </div>
