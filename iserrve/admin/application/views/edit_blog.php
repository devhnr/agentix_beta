                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label style="width:100%; margin:15px 0 5px;" for="image">Image (Size :320px X 328px)</label>
                                ...
                                <div class="form-group">
                                    <label style="width:100%; margin:15px 0 5px;" for="image">Detail Image (Size :1350px X 350px )</label>
...
<script src="<?php echo $base_url_views; ?>/ckeditor_new/ckeditor.js"></script>
<script>/* 
