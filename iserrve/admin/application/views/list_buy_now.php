...
<!-- Start: Main --><div id="main">   
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">Buy Now</a></li>         

 <li class="crumb-icon"><a href="<?php echo $base_url; ?>">

 <span class="glyphicon glyphicon-home"></span></a></li>                   

 <li class="crumb-trail">Buy Now</li>        
 ...
 <div class="col-md-12">		
  ...
  <a href="<?php echo $base_url;?>buy_now/createExcel" class="btn btn-alert pull-right"> Download Excel</a>

  <!-- <form action="<?php echo $base_url."buy_now/download_user";?>" method="post" enctype="multipart/form-data">
 ...
 <span class="glyphicon glyphicon-list-alt"></span>Buy Now Listing </span> 

 </div>            <div class="panel-body">			  

 <form action="<?php echo $base_url."buy_now/deletes";?>" method="post" enctype="multipart/form-data" id="form">			  
...
<i class="fa fa-pencil"></i></a></td> -->					  
 ...
 <?php } } else {	 echo 'No Buy Now Found';
