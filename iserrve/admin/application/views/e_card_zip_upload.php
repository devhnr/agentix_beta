                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                <form method="POST" action="<?php echo $base_url;?>ecards/upload_zip" enctype="multipart/form-data">
                    ...
                                            <option>--Selected--</option>
                                            ...
                                            <option value="<?php echo $policy_no->id; ?>" <?php if ($policy_no->id == $this->session->userdata('policy_id_session')) {
                                                echo "selected"; } ?>><?php echo $policy_no->product_name; ?></option>
                                        <?php } }  ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;">File Upload <span class="mandatory_field">*</span></label>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click','#btnUpload', function(){
            ...
            if(banner_ex != '' && banner_ex != 'zip' ){
                $("#reg1_err").html("Only support zip file type").show();
                return false;
            }
        });
