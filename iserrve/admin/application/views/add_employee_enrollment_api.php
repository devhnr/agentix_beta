                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>enrollment_api/add"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span id="show_insurer">
                                            <input type="text" name="insurer" id="insurer" class="form-control" readonly>
...
<script type="text/javascript">
    ...
    function showpolicy(pro_id){
        // alert(pro_id);exit;
        var url = '<?php echo $base_url; ?>enrollment_api/show_policy_using_corporate';
