   ...
   <section id="content_wrapper">
      <div id="topbar">
         <div class="topbar-left">
            <ol class="breadcrumb">
               <li class="crumb-active"><a href="javascript:void(0);">Utilities</a></li>
               <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                  class="glyphicon glyphicon-home"></span></a></li>
               <li class="crumb-trail">Utilities</li>
            </ol>
         </div>
      </div>
      ...
      <div id="content">
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <a href="<?php echo $base_url;?>utilities/add/" class="btn btn-alert pull-right"><i
                  class="fa fa-plus"></i> Add Utilities</a>
            </div>
            ...
            <div class="col-md-12">
               <div class="panel">
                  <div class="panel-heading"> <span class="panel-title"> <span
                     class="glyphicon glyphicon-list-alt"></span>Utilities Listing </span> </div>
                  <div class="panel-body">
                     <form action="<?php echo $base_url."utilities/deletes";?>" method="post"
                           ...
                           <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $this->utilities_model->get_corporate_name($result[$i]->corporate_id); ?></td>
                                    
                                    <td><?php echo $this->utilities_model->get_policy_no($result[$i]->policy_no); ?></td>

                                    <td><?php echo $this->utilities_model->get_document_type($result[$i]->document_type); ?></td>

                                    <td><?php echo $this->utilities_model->get_policy_type($result[$i]->policy_type); ?></td>

                                    <td><?php echo $result[$i]->note; ?></td>
                                    <td>
                                       <?php if($result[$i]->document != ''){ ?>
                                       <a target="_blank" href="<?php echo $front_base_url; ?>upload/utilities/<?php echo $result[$i]->document; ?>" class="btn btn-alert ">View Document</a>
                                       <?php } ?>
                                    </td>
                                    
                                    <?php if(in_array('29',$permission1)){ ?>
                                    <td><a class="btn bg-purple2" title="Edit"
                                       href="<?php echo $base_url."utilities/edit/"; ?><?php echo $result[$i]->id; ?>">
...
<script type="text/javascript">
   $(document).ready(function($) {
       ...
       $('#reset').click(function() {
           ...
           var base_url = '<?php echo $base_url.'utilities/lists'; ?>';
       ...
       $.ajax({
           ...
           url: '<?php echo $base_url; ?>utilities/ajaxlist_country',
...
<script>
   ...
   
   {
   ...
   
       {
           ...
           var base_url = '<?php echo $base_url. 'utilities/featured_product';?>';
...
<script>
   function updateorder(val, id) {
       ...
       var t = confirm('Are you sure you want to Set order of Utilities');
   
       if (t) {
   
           window.location.href = '<?php echo $base_url;?>utilities/updateorder/' + id + '/' + val;
