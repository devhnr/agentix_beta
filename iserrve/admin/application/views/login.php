      ...
      <div class="panel-bg">
        ...
        <!--  <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock text-purple2"></span> Login </span> </div> -->
          ...
          <div class="panel-body">
            ...
            <div class="login-avatar"><img src="<?php echo $base_url_views;?>images/isserve.png"  alt="iSerrve">
...
<?php }  ?>			</div>
		  ...
		  <button type="submit" class="btn btn-sm bg-purple2 " onclick="javascript:validate();return false;">
      Login</button>
