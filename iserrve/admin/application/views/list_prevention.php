...
<!-- Start: Main --><div id="main">
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">Prevention</a></li>

 <li class="crumb-icon"><a href="<?php echo $base_url; ?>">

 <span class="glyphicon glyphicon-home"></span></a></li>

 <li class="crumb-trail">Prevention</li>
...
<?php } ?>
 ...
 <span class="glyphicon glyphicon-list-alt"></span>Prevention Listing </span>
 ...
 <tbody>
 		...
 		<?php foreach ($prevention as $value) {  ?>
            <tr>
         ...
         if (checkbox.length > 0) {
             ...
             if (conf == true) {
                 $.ajax({
                     ...
                     method: "POST",
                     data: {checkbox_value: checkbox_value, tbl : 'tbl_prevention'},
                     success: function() {
                       var base_url = '<?php echo $base_url.'home/prevention_list'; ?>';
