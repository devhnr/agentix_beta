    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);">Edit State</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>state/lists">State</a></li>
                    <li class="crumb-trail">Edit State</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Edit State </span> </div>
  ...
  { ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>state/edit/<?php echo $id; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control"
                                            placeholder="Enter State Name" value="<?php echo $name; ?>" />
                                    </div>

                                    <div class="form-group">
                                        <input class="submit btn bg-purple pull-right" type="submit" value="Update"
                                            onclick="javascript:validate();return false;" />
                                        <a href="<?php echo $base_url;?>state/lists"
...
function validate() {
    var name = $("#name").val();
    if (name == '') {
        $("#error_msg1").html("Please Enter State Name.");
