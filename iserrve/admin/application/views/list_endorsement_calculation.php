        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>endorsement_calculation/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Endorsement Calculation</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Endorsement Calculation Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."endorsement_calculation/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo $this->endorsement_calculation_model->get_corporate_name($result[$i]->corporate_id); ?></td>

                                             

                                               <td><?php echo $this->endorsement_calculation_model->get_policy_no($result[$i]->policy_no); ?></td>
                                             ...
                                             <!--    <td>
                                                ...
                                                <!-- <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."endorsement_calculation/edit/"; ?><?php echo $result[$i]->id; ?>">
					  ...
					  echo 'No Endorsement Calculation Found';
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'endorsement_calculation/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>endorsement_calculation/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'endorsement_calculation/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of Endorsement Calculation');

    if (t) {

        window.location.href = '<?php echo $base_url;?>endorsement_calculation/updateorder/' + id + '/' + val;
