...
<!-- Start: Main --><div id="main">   
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">Get Qoute(Talk to Our Expert)</a></li>         

 <li class="crumb-icon"><a href="<?php echo $base_url; ?>">

 <span class="glyphicon glyphicon-home"></span></a></li>                   

 <li class="crumb-trail">Get Qoute(Talk to Our Expert)</li>        
 ...
 <b>Error!</b> <?php echo $this->session->flashdata('flashError',5); ?>                                    
  ...
  <!-- <form action="<?php echo $base_url."get_qoute_expert/download_user";?>" method="post" enctype="multipart/form-data">
 ...
 <span class="glyphicon glyphicon-list-alt"></span>Get Qoute(Talk to Our Expert) Listing </span> 

 </div>            <div class="panel-body">			  

 <form action="<?php echo $base_url."get_qoute_expert/deletes";?>" method="post" enctype="multipart/form-data" id="form">			  
...
<td><?php echo $this->get_qoute_expert_model->get_productname($result[$i]->product_id);?></td>
...
<i class="fa fa-pencil"></i></a></td> -->					  
 ...
 <?php } } else {	 echo 'No Get Qoute(Talk to Our Expert) Found';
