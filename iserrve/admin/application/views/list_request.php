...
<!-- Start: Main --><div id="main">
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">Employee Request</a></li>

 <li class="crumb-icon"><a href="<?php echo $base_url; ?>">

 <span class="glyphicon glyphicon-home"></span></a></li>

 <li class="crumb-trail">Employee Request</li>
...
<?php } ?>
 ...
 <span class="glyphicon glyphicon-list-alt"></span>Employee Request Listing </span>
 ...
 <tbody>
 		...
 		<?php foreach ($request as $value) {  ?>
            <tr>
                ...
                <td><?=$value['request']?></td>
                <td><?php if($value['type'] == 1){echo 'Add/Delete';}else{ echo 'Edit';}?></td>
         ...
         if (checkbox.length > 0) {
             ...
             if (conf == true) {
                 $.ajax({
                     ...
                     method: "POST",
                     data: {checkbox_value: checkbox_value, tbl : 'tbl_request'},
                     success: function() {
                       var base_url = '<?php echo $base_url.'home/request_list'; ?>';
