...
<div id="main">
    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);">Product Type</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-trail">Product Type</li>
                </ol>
            </div>
        </div>
  ...
  ?>
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>product_type/add/" class="btn btn-alert pull-right"><i
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Product Type </span> </div>
                        <div class="panel-body">
                            <form action="<?php echo $base_url."product_type/deletes";?>" method="post"
				...
				?>
                                            <tr>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."product_type/edit/"; ?><?php echo $result[$i]['id'];?>">
...
function updateorder(val, id) {
    var t = confirm('Are you sure you want to Set order of Product Type');
    if (t) {
        window.location.href = '<?php echo $base_url;?>product_type/updateorder/' + id + '/' + val;
    } else {
        return false;
    }
}
