   ...
   <section id="content_wrapper">
      <div id="topbar">
         <div class="topbar-left">
            <ol class="breadcrumb">
               <li class="crumb-active"><a href="javascript:void(0);">Escalation Level</a></li>
               <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                  class="glyphicon glyphicon-home"></span></a></li>
               <li class="crumb-trail">Escalation Level</li>
            </ol>
         </div>
      </div>
      ...
      <div id="content">
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <a href="<?php echo $base_url;?>escalation_level/add/" class="btn btn-alert pull-right"><i
                  class="fa fa-plus"></i> Add Escalation Level</a>
            </div>
            ...
            <div class="col-md-12">
               <div class="panel">
                  <div class="panel-heading"> <span class="panel-title"> <span
                     class="glyphicon glyphicon-list-alt"></span>Escalation Level Listing </span> </div>
                  <div class="panel-body">
                     <form action="<?php echo $base_url."escalation_level/deletes";?>" method="post"
                        ...
                        if($corporate_data->active_deactive == 0 && $policy_data->policy_end_date >= date('Y-m-d')){
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $this->escalation_level_model->get_corporate_name($result[$i]->corporate_id); ?></td>
                                    
                                    <td><?php echo $this->escalation_level_model->get_policy_no($result[$i]->policy_no); ?></td>
                                    <td>
                                       <?php
                                          if($result[$i]->level == 1){
                                             echo "Level 1";
                                          }elseif($result[$i]->level == 2){
                                             echo "Level 2";
                                          }elseif($result[$i]->level == 3){
                                             echo "Level 3";
                                          }elseif($result[$i]->level == 4){
                                             echo "Level 4";
                                          }elseif($result[$i]->level == 5){
                                             echo "Level 5";
                                          }elseif($result[$i]->level == 6){
                                             echo "Level 6";
                                          }elseif($result[$i]->level == 7){
                                             echo "Level 7";
                                          }elseif($result[$i]->level == 8){
                                             echo "Level 8";
                                          }else{
                                             echo "-";
                                          }
                                    ...
                                    <td>
                                       <?php 
                                          $user_data = $this->escalation_level_model->get_escalation_user_data($result[$i]->user_id); 
                                    ...
                                    <!-- <td><a class="btn bg-purple2" title="Edit"
                                       href="<?php echo $base_url."escalation_level/edit/"; ?><?php echo $result[$i]->id; ?>">
                                 ...
                                 <?php
                                    ...
                                    echo 'No Escalation Level Found';
...
<script type="text/javascript">
   $(document).ready(function($) {
       ...
       $('#reset').click(function() {
           ...
           var base_url = '<?php echo $base_url.'escalation_level/lists'; ?>';
       ...
       $.ajax({
           ...
           url: '<?php echo $base_url; ?>escalation_level/ajaxlist_country',
...
<script>
   ...
   
   {
   ...
   
       {
           ...
           var base_url = '<?php echo $base_url. 'escalation_level/featured_product';?>';
...
<script>
   function updateorder(val, id) {
       ...
       var t = confirm('Are you sure you want to Set order of Escalation Level');
   
       if (t) {
   
           window.location.href = '<?php echo $base_url;?>escalation_level/updateorder/' + id + '/' + val;
