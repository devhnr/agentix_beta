...
<!-- Start: Main --><div id="main">
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">Protection</a></li>

 <li class="crumb-icon"><a href="<?php echo $base_url; ?>">

 <span class="glyphicon glyphicon-home"></span></a></li>

 <li class="crumb-trail">Protection</li>
...
<?php } ?>
 ...
 <span class="glyphicon glyphicon-list-alt"></span>Protection Listing </span>
 ...
 <tbody>
 		...
 		<?php foreach ($protection as $value) {  ?>
            <tr>
         ...
         if (checkbox.length > 0) {
             ...
             if (conf == true) {
                 $.ajax({
                     ...
                     method: "POST",
                     data: {checkbox_value: checkbox_value, tbl : 'tbl_protection'},
                     success: function() {
                       var base_url = '<?php echo $base_url.'home/protection_list'; ?>';
