            ...
            <div class="row">
				...
				?>
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo $this->sum_insured_model->get_corporate_name($result[$i]->corporate_id); ?></td>

                                               <!-- <td><?php //echo $this->sum_insured_model->get_product_name($result[$i]->product_name); ?></td> -->

                                               <td><?php echo $result[$i]->product_name; ?></td>

                                               <td><?php echo $this->sum_insured_model->get_policy_no($result[$i]->policy_no); ?></td>

                                                <td><?php echo number_format($result[$i]->sum_insured); ?></td>
...
<!-- Modal -->
  <div class="modal fade" id="myModal_sum_insured" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align:center;">
            ...
            <p class="model_success_p1">Sum Insured Create Successfully</p>
            <p class="model_success_p2">Please Click On Next Button TO Create Policy Features</p>
            <button type="button" class="btn btn-default" data-dismiss="modal">Stay Here</button>
            <a href="<?php echo $base_url;?>policy_features/add/" class="btn btn-default">Next</a>
        </div>
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of sum_insured');
...
if($this->session->flashdata('L_strErrorMessage') == 'Sum Insured Added Successfully') { ?>
    <script>
        $("#myModal_sum_insured").modal('show');
    </script>
<?php } //} ?>