         ...
         <div class="topbar-left">
            <ol class="breadcrumb">
               <li class="crumb-active">
                  <a href="javascript:void(0);">Talk to Our Expert</a>
               </li>
               <li class="crumb-icon"><a href="<?php echo $base_url; ?>">
                  <span class="glyphicon glyphicon-home"></span></a>
               </li>
               <li class="crumb-trail">Talk to Our Expert</li>
            </ol>
         </div>
      </div>
      <?php
      ...
      <div id="content">
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <a href="<?php echo $base_url;?>talk_to_expert/createExcel" class="btn btn-alert pull-right"> Download Excel</a>
               <!-- <form action="<?php echo $base_url."talk_to_expert/download_talk_to_expert";?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
               <div class="panel">
                  <div class="panel-heading"> 
                     ...
                     <span class="glyphicon glyphicon-list-alt"></span>Talk to Our Expert Listing </span> 
                  </div>
                  <div class="panel-body">
                     <form action="<?php echo $base_url."talk_to_expert/deletes";?>" method="post" enctype="multipart/form-data" id="form">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <!--   <td><a class="btn bg-purple2" title="Edit"
                                       href="<?php // echo $base_url."talk_to_expert/edit/"; ?><?php //echo $result[$i]->id; ?>">
                                       
                                       <i class="fa fa-pencil"></i></a></td> -->					  
                                 </tr>
                                 <?php } } else {	 echo 'No Talk to Our Expert Found';
                                    }  ?>	
                                 </body>                
                           </table>
                        </div>
