...
$trailer = '<a href="javascript:void(0)"   onclick="window.open($project->trailer, 'newwindow', 'width=900,height=550'); return false;" class="genre-btn d-block mt-2">Watch Trailer</a>';


<?php if($project->showreel == 'javascript:void(0)'){ ?>
	<a href="javascript:void(0)"  class="genre-btn d-block mt-2" disabled>Watch Showreel</a>
		<?php } else{ ?>
		<a href="javascript:void(0)"  onclick="window.open('<?php echo $project->showreel ?>', 'newwindow', 'width=900,height=550');" class="genre-btn d-block mt-2">Watch Showreel</a>
<?php } ?>

<?php if($project->trailer == 'javascript:void(0)'){ ?>
		<a href="javascript:void(0)"  onclick="window.open('<?php echo $project->trailer ?>', 'newwindow', 'width=900,height=550');" class="genre-btn d-block mt-2" disabled>Watch Trailer</a>
<?php } else{ ?>
<a href="javascript:void(0)"  onclick="window.open('<?php echo $project->trailer ?>', 'newwindow', 'width=900,height=550');" class="genre-btn d-block mt-2">Watch Trailer</a>
<?php } ?>