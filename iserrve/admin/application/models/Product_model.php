<?php
...

	{
		...
		{	
          ...
          // echo "<pre>";print_r($_POST['for_employee']);echo "</pre>";exit;
             if (count($_POST['section3_desc']) > 0 && $_POST['section3_desc'] != '') 
            {
                ...
                {   
                    if($_POST['section3_desc'][$i] !='')
                    {
                        ...
                        $data1['pro_id'] = $id;
                         $data1['for_employee'] = $_POST['for_employee'][$i];
                ...
                for ($i = 0; $i < count($_POST['desctiption1']); $i++) {
                    ...
                    if ($_POST['desctiption1'][$i] != '') {
                        $content2['pro_id'] = $id;
                         ...
                         $content2['for_employee'] = $_POST['for_employee1'][$i];
             ...
             if (count($_POST['descriptionu']) > 0 && $_POST['descriptionu'] != '') {
                ...
                for ($i = 0; $i < count($_POST['descriptionu']); $i++) {
                     ...
                     $content1['pro_id'] = $id;
                      ...
                      $content1['for_employeeu'] = $_POST['for_employeeu'][$i];
    ...
    function update_advantage_group_ins($content) 
    {
        ...
        $data1['for_employee'] = $content['for_employeeu'];
