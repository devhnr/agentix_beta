...
class Corporate_dashboard_model extends CI_Model {
	...
	function get_policy_feature_details($corp_id,$policy_id){
		$policy_features_id = isset($_GET['sum_insured']) ? $_GET['sum_insured']:null;
		$sql = "SELECT * FROM policy_features where corporate_id = '".$corp_id."' and policy_no = '".$policy_id."' and id = '".$policy_features_id."'";
		$query = $this->db->query($sql);
	...
	function get_other_benefit($corp_id,$policy_id){
		$policy_features_id = isset($_GET['sum_insured']) ? $_GET['sum_insured']:null;
		$sql = "SELECT * FROM policy_features where corporate_id = '".$corp_id."' and policy_no = '".$policy_id."' and id = '".$policy_features_id."'";
		$query = $this->db->query($sql);
...
function get_corporate_name($id) {
	...
	function get_e_card_dev($policy_id,$employee_id){

		$sql = "SELECT * FROM tbl_e_card where employee_id = '".$employee_id."' and policy_id = '".$policy_id."'";
		$query = $this->db->query($sql);
	...
	public function get_e_card_new($policy_id,$employee_id){
        try{
	...
	function get_claim_status_report_cashless_paid($corporate_id,$policy_id){
		...
		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_type = 'CASHLESS' and claim_status = 'paid'";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_claim_status_report_cashless_rejected($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_type = 'CASHLESS' and (claim_status='rejected' OR claim_status='repudiated')";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_claim_status_report_Reimbursement_outstandindg($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_type = 'REIMBURSEMENT' and (claim_status='under process' OR claim_status='under process - deficiency' OR claim_status ='intimidated and file not recieved' OR claim_status ='AL issued' OR claim_status ='Intimated')
		";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
	...
	function get_claim_status_report_Reimbursement_paid($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_type = 'REIMBURSEMENT' and claim_status = 'paid'";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_claim_status_report_Reimbursement_rejected($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_type = 'REIMBURSEMENT' and (claim_status='rejected' OR claim_status='repudiated')";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_month_wise_report_cashless_jan($corporate_id,$policy_id){
	...
	function get_month_wise_report_Reimbursement_jan($corporate_id,$policy_id){
	...
	function get_gender_wise_report_female($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and (gender='F' OR gender='Female')";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_gender_wise_report_male($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and (gender='M' OR gender='Male')";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_relation_wise_report_daughter($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and (relation='DAUGHTER' OR relation='DAUGHTER1')";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function top_ten_claim_hospital_data($corporate_id,$policy_id){

	$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." ";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function top_ten_paid_claim_hospital_data($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_status='Paid' ";
			$query = $this->db->query($sql);
			if($query->num_rows() > 0)
			{
				$result = $query->result();
	...
	function get_relation_wise_report_employee($corporate_id,$policy_id,$relation){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and relation='".$relation."'";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_relation_wise_report_spouce($corporate_id,$policy_id){

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and (relation='spouse' OR relation='wife' OR relation='husband')";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_age_band_wise_report_closed($corporate_id,$policy_id,$age){

		$age = explode('-', $age);

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_status='Closed' and age between ".$age[0]." and ".$age[1]." ";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_age_band_wise_report_outsatnding($corporate_id,$policy_id,$age){

		$age = explode('-', $age);

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and (claim_status='under process' OR claim_status='under process - deficiency' OR claim_status ='intimidated and file not recieved' OR claim_status ='AL issued' OR claim_status ='Intimated') and age between ".$age[0]." and ".$age[1]." ";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_age_band_wise_report_paid($corporate_id,$policy_id,$age){

		$age = explode('-', $age);

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and claim_status='Paid' and age between ".$age[0]." and ".$age[1]." ";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_age_band_wise_report_rejected($corporate_id,$policy_id,$age){

		$age = explode('-', $age);

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id." and (claim_status='rejected' OR claim_status='repudiated') and age between ".$age[0]." and ".$age[1]." ";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_demography_graph_report($corporate_id,$policy_id){
	...
	function get_demography_graph_report_using_suminsured($corporate_id,$policy_id,$sum_insured){

		$age = explode('-', $age);

		$sql = "SELECT * FROM upload_claims WHERE corporate   = ".$corporate_id." and policy_no  = ".$policy_id."  and sum_insured = ".$sum_insured."";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	function get_endersoment_report($corporate_id,$policy_id){

		$sql = "SELECT * FROM endorsement_transaction WHERE corporate_id   = ".$corporate_id." and policy_no  = ".$policy_id." and policy_endorsement_entry = 1";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$result = $query->result();
	...
	public function get_policy_no($policy_id) {
		...
		public function get_sum_insured($policy_id,$corporate_id) {
				try{
