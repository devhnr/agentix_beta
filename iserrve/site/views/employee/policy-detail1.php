							...
							<div class="v-panel">
								 <div class="panel-inner">
								 	<div class="row align-items-center ">
												...
												<?php if(!empty($policy_features)){ foreach ($policy_features as $p) { ?>
													<div class="det-feature-sec">
																...
																<?php if(!empty($p['addition'])) {
																							$result = $this->em->get_sub_policy_features_attribute($policy_data['id'],$p['field_id']);
											...
											<div class="col-lg-12">
												<?php if($other_benefit->inclusions != ''){ 
												?>
														 
														<div class="det-feature-sec" style="width:100% !important;">
																<div class="det-feature-box">
