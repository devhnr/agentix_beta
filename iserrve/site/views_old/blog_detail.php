        ...
        <div class="blog-det-col">
          <div class="blog-det-contain">
            <div class="blog-back text-center">
              <a href="<?php echo $http_host?>blog-listing"><i class="feather icon-feather-arrow-left"></i> Back to Insights</a>
            </div>
          ...
          <?php } ?>
            <div class="blog-back text-center">
              <a href="<?php echo $http_host?>blog-listing" class="mt-5"><i class="feather icon-feather-arrow-left"></i> Back to Insights</a>
            </div>
