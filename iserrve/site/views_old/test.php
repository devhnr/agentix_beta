    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-9 bg-white">
                <form id="regForm" role="regForm" method="post" action="<?php echo $http_host;?>home/register">
            ...
            <div class="row">
                    ...
                    <span id="tab3_success" class="successmain alert-message"
                       ...
                       <div style="float:right;">
                            ...
                            <button type="button" class="v-btn  margin-20px-bottom phn_error" id="nextBtn12" onclick="get_hide_show(6);">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
   function get_hide_show(id)
   {
    ...
    // alert(sum_insurance_val);
                         ...
                         var url = '<?php echo $http_host;?>home/otpsent';
