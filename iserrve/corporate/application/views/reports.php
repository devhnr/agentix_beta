    ...
    <div class="container-fluid">
        <div class="content-header" style="padding-top: 0px !important;">
            <div class="container-fluid">
                ...
                <div class="col-lg-9" id="mobo-link">
                <div class="vtabcontent" id="Tab1">
                                ...
                                <div class="col-lg-12">
                                    <div class="card border-1px new-border-radius">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-2 mt-2">
                                                <div class="col-12">
                                                    <table class="table w-00 table-responsive text-nowrap">
                                                        <thead class="thead-light font-size-15px">
                                                            <tr>
                                                                <th scope="col">Claim Type</th>
                                    ...
                                    <div class="card border-1px new-border-radius">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-2 mt-2">
                                                <div class="col-sm-7 mb-2 mt-2">
                                                <div class="charts">
                                                    <canvas id="barChart5" class="w-100"></canvas>
                                                </div>
                                            </div>
                                            <div class="row mb-2 mt-2">
                                                <div class="col-12">
                        ...
                        <div class="vtabcontent" id="Tab10">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <div class="card border-1px new-border-radius">
                                        <div class="card-body">
