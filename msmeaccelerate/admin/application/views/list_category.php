        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Industry</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Industry</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>category/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Industry</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Industry Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."category/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td><input name="selected[]" id="selected[]"
                                                 ...
                                                 <!--<td><?php echo $this->category_model->getgourp_name($result[$i]->group_id); ?> -->
                                                </td> 
                                             ...
                                             <!--    <td>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."category/edit/"; ?><?php echo $result[$i]->id; ?>">
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'category/featured_product';?>';
...
function updateorder(val, id) {
    ...
    if (t) {
        ...
        window.location.href = '<?php echo $base_url;?>category/updateorder/' + id + '/' + val;
