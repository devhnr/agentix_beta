    ...
    <div id="topbar">
      ...
      <div class="topbar-left">
        ...
        <ol class="breadcrumb">
          ...
          <li class="crumb-active"><a href="javascript:void(0);">subscribe2</a></li>

          <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span class="glyphicon glyphicon-home"></span></a></li>         
          <li class="crumb-trail">Subscribe</li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Subscribe Listing </span> </div>

            <div class="panel-body">

			  <form action="<?php echo $base_url."subscribe2/deletes";?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <div class="table-responsive">
				...
				<tr>
					...
					<td><?php echo $result[$i]->email_sub; ?></td>
					<!-- <td style="width:350px;"><?php echo $result[$i]->message; ?></td> -->

                    <!-- <td>
					<select title="Approve" onchange="javascript:approve('<?php echo $base_url."download/updatestatus/"; ?><?php echo $result[$i]->id; ?>',this.value);" >

						<option value="1" <?php if($result[$i]->status ==1) { echo "selected"; } ?>>Active</option>
						<option value="0" <?php if($result[$i]->status ==0) { echo "selected"; } ?>>Deactive</option>	
						</select>
				...
				<?php
					  ...
					  echo 'No Subscribe Listing Found';
				  }
                ?>
                  </tbody>
