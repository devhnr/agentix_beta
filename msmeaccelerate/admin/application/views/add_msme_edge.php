    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Add MSME Accelerate Edge</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>msme_edge/lists">MSME Accelerate Edge</a></li>
                    <li class="crumb-trail">Add a MSME Accelerate Edge</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Add MSME Accelerate Edge</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>msme_edge/add"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="add_msme_edge">

                                    <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="name">Name</label>
                                        <input id="name" name="name" type="text" placeholder="Enter Name" class="form-control" value="" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Image (Size : 150px X 150px)</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo $base_url;?>msme_edge/lists"
