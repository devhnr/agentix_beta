    ...
    <div id="topbar">
      ...
      <div class="topbar-left">
        ...
        <ol class="breadcrumb">
		  ...
		  <li class="crumb-active"><a href="javascript:void(0);"> Edit About </a></li>

          <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span class="glyphicon glyphicon-home"></span></a></li>

          <li class="crumb-link"><a href="<?php echo $base_url; ?>about/edit/1">About</a></li>

          <li class="crumb-trail">Edit About</li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel">
            ...
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit About</span> </div>
...
<?php }  ?>
      ...
      <b>Error &nbsp; </b><span id="error_msg1"></span>
        ...
        <form role="form" id="form" method="post" action="<?php echo $base_url;?>about/edit/<?php echo $id; ?>" enctype="multipart/form-data" >
        ...
        <div class="col-md-12"> 
         ...
         <div class="col-md-12"> 
             <div class="form-group">
                <label style="width:100%; margin:15px 0 5px;" for="name">Image (Size: 500px x 580px)</label>
                <input id="image" name="image" type="file" class="form-control" value=""/>
                <img src="<?php echo $front_base_url; ?>upload/about_image/large/<?php echo $image; ?>" height="50" width="50">
            </div>
        </div>
