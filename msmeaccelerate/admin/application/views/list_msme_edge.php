    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);">MSME Accelerate Edge</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-trail">MSME Accelerate Edge</li>
                </ol>
            </div>
        </div>
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>msme_edge/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add MSME Accelerate Edge</a>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>MSME Accelerate Edge Listing</span> </div>
                        <div class="panel-body">
                            <form action="<?php echo $base_url."msme_edge/deletes";?>" method="post"
				...
				?>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $front_base_url; ?>upload/msme_edge_image/medium/<?php echo $result[$i]->image; ?>"
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."msme_edge/edit/"; ?><?php echo $result[$i]->id; ?>">
					  ...
					  echo 'No MSME Accelerate Edge Found';
				  }
                ?>
...
$(document).ready(function($) {
    $('#reset').click(function() {
        var base_url = '<?php echo $base_url.'msme_edge/lists'; ?>';
...
function updateorder(val, id) {
    var t = confirm('Are you sure you want to Set order of MSME Accelerate Edge');
    if (t) {
        window.location.href = '<?php echo $base_url;?>msme_edge/updateorder/' + id + '/' + val;
    } else {
        return false;
    }
}
