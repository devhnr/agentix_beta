...
<div id="main">
    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);">Banner</a></li>
  ...
  ?>
                ...
                <!-- <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>banner/add/" class="btn btn-alert pull-right"><i
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Banner Listing</span> </div>
                        <div class="panel-body">
                            <form action="<?php echo $base_url."banner/deletes";?>" method="post"
				...
				?>
                                            <tr>
                                                ...
                                                <td><?php echo $result[$i]->title1; ?></td>
                                                <!-- <td><?php //echo $result[$i]->title2; ?></td>
                                                <td><?php //echo $result[$i]->title3; ?></td> -->
                                                <td><img src="<?php echo $front_base_url; ?>upload/banner/<?php echo $result[$i]->image; ?>"
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."banner/edit/"; ?><?php echo $result[$i]->id; ?>">
...
function updateorder(val, id) {
    var t = confirm('Are you sure you want to Set order of Banner');
    if (t) {
        window.location.href = '<?php echo $base_url;?>banner/updateorder/' + id + '/' + val;
    } else {
        return false;
    }
}
