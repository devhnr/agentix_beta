    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);">Career</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-trail">Career</li>
                </ol>
            </div>
        </div>
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>career/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Career</a>
                </div>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Career Listing</span> </div>
                        <div class="panel-body">
                            <form action="<?php echo $base_url."career/deletes";?>" method="post"
				...
				?>
                                            <tr>
                                               ...
                                               <!--  <td><?php echo $result[$i]->description; ?></td> -->
                                                ...
                                                <!-- <td><img src="<?php echo $front_base_url; ?>upload/banner/<?php echo $result[$i]->mobile_image; ?>"
                                                        style="height: 103px; width: 33%;"></td>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."career/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    $('#reset').click(function() {
        var base_url = '<?php echo $base_url.'career/lists'; ?>';
...
function updateorder(val, id) {
    var t = confirm('Are you sure you want to Set order of Career');
    if (t) {
        window.location.href = '<?php echo $base_url;?>career/updateorder/' + id + '/' + val;
    } else {
        return false;
    }
}
