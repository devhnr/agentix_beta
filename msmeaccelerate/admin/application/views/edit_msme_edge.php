    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit MSME Accelerate Edge </a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>msme_edge/lists">MSME Accelerate Edge</a></li>
                    <li class="crumb-trail">Edit MSME Accelerate Edge</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Edit MSME Accelerate Edge</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>msme_edge/edit/<?php echo $id; ?>"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_msme_edge">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="image">Image (Size : 150px X 150px)</label>
                                        <input type="file" name="image" id="image" value="" class="form-control">
                                        <img src="<?php echo $front_base_url; ?>upload/msme_edge_image/medium/<?php echo $image; ?>" height="50px;" width="50px;">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>msme_edge/lists" class="submit btn bg-purple pull-right"
