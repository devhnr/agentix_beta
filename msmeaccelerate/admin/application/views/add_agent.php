    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Add Agent</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>agent/lists">Agent</a></li>
                    <li class="crumb-trail">Add a Agent</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Add Agent </span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>agent/add"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" type="text" placeholder="Enter Agent Name" class="form-control" value="" />
                                    </div>

                                     <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="email">Agent E-mail</label>
                                        <input id="email" name="email" type="text" placeholder="Enter Agent E-mail" class="form-control" value="" />
                                    </div>

                                     <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="agent_id">Agent ID</label>
                                        <input id="agent_id" name="agent_id" type="text" placeholder="Enter Agent ID" class="form-control" value="" />
                                    </div>

                                     <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="password">Agent Password</label>
                                        <input id="password" name="password" type="text" placeholder="Enter Agent Password" class="form-control" value="" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo $base_url;?>agent/lists"
...
function validate() {
    ...
    if (name == '') {
        ...
        $("#error_msg1").html("Please Enter Agent Name.");
    ...
    if (email == '') {
        //alert('Please Enter Category ');
        $("#error_msg1").html("Please Enter Agent E-mail.");
        $("#validator").css("display", "block");
        return false;
    }
