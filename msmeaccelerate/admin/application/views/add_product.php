                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>product/add"
                                    ...
                                    <label for="type_id" style="width:100%;margin:15px 0 5px;">Type</label>
                                        <span id="prod1">
                                        <select id="type_id" name="type_id"  class="form-control">
                                            <option value="">Select Type</option>
                                            <?php  if($all_type !='' && count($all_type) > 0){ 
                                            foreach($all_type as $type_detail){ ?>
                                            <option value="<?php echo $type_detail->id; ?>" <?php if($type_detail->id == $type_id){ echo "selected";} ?>><?php echo $type_detail->name; ?></option>      
                                        <?php } }  ?>             
                                        </select>
                                    </span>
                                </div>
                                 ...
                                 <div class="form-group">
                                    <label for="coverage_id" style="width:100%;margin:15px 0 5px;">Coverage</label>
                                        <span id="prod1">
                                        <select id="coverage_id" name="coverage_id[]" multiple  class="form-control">
                                            ...
                                            <option value="<?php echo $coverage->id; ?>" <?php if(in_array($coverage->id,$coverage_id)){ echo "selected";} ?>><?php echo $coverage->name; ?></option>      
                                        <?php } }  ?>             
                                        </select>
                                    </span>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control"
                                            placeholder="Enter Name" value="<?php if(!empty($name)){ echo $name; } ?>" />
                                    </div>

                                      <div class="form-group">
                                        <label style="width:100%;margin:15px 0 5px;">Image (Size : 76px X 76px)</label>
                                        <input type="file" name="image" id="image" value="<?php if(!empty($image)){ echo $image; } ?>" class="form-control">
                                ...
                                <div class="row col-md-12" id="div_first">
                                    <div class="form-group">
                                        ...
                                        <input id="zero_to_hundred" name="zero_to_hundred" type="text" class="form-control"
                                            placeholder="Enter 0 - 100 Crore" value="<?php if(!empty($zero_to_hundred)){ echo $zero_to_hundred; } ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="hund_to_five" name="hund_to_five" type="text" class="form-control"
                                            placeholder="Enter Above 100 - 500 Crore" value="<?php if(!empty($hund_to_five)){ echo $hund_to_five; } ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="above_five" name="above_five" type="text" class="form-control"
                                            placeholder="Enter Above 500 crore" value="<?php if(!empty($above_five)){ echo $above_five; } ?>" />
                                    </div>
                                </div>
                                <!-- ----------------------   Drop-Down  ---------------------- -->
                                ...
                                <div class="row col-md-12" id="div_three">
                                    ...
                                    <label for="show_price" style="width:100%;margin:15px 0 5px;">0 to 100 Crore</label>
                                        <span id="prod1">
                                            ...
                                            <div style="width:49%;display: inline-block;">
                                                ...
                                                <input type="text" name="emp_zero_to_hundred_amount" id="emp_zero_to_hundred_amount" class="form-control" value="<?php if(!empty($emp_zero_to_hundred_amount)){ echo $emp_zero_to_hundred_amount; } ?>">
                                            </div>
                                            <div style="width:49%;display: inline-block;">
                                                <label for="show_price" style="width:100%;margin:15px 0 5px;">Percentage</label>
                                                <input type="text" name="emp_zero_to_hundred_percentage" id="emp_zero_to_hundred_percentage" class="form-control" value="<?php if(!empty($emp_zero_to_hundred_percentage)){ echo $emp_zero_to_hundred_percentage; } ?>">
                                            </div>
                                    ...
                                    <label for="show_price" style="width:100%;margin:15px 0 5px;">100 to 500 Crore</label>
                                        <span id="prod1">
                                            ...
                                            <div style="width:49%;display: inline-block;">
                                                <label for="show_price" style="width:100%;margin:15px 0 5px;">Amount</label>
                                                <input type="text" name="emp_hund_to_five_amount" id="emp_hund_to_five_amount" class="form-control" value="<?php if(!empty($emp_hund_to_five_amount)){ echo $emp_hund_to_five_amount; } ?>">
                                            </div>
                                            <div style="width:49%;display: inline-block;">
                                                <label for="show_price" style="width:100%;margin:15px 0 5px;">Percentage</label>
                                                <input type="text" name="emp_hund_to_five_percentage" id="emp_hund_to_five_percentage" class="form-control" value="<?php if(!empty($emp_hund_to_five_percentage)){ echo $emp_hund_to_five_percentage; } ?>">
                                            </div>
                                    ...
                                    <label for="show_price" style="width:100%;margin:15px 0 5px;">Above 500 Crore</label>
                                        <span id="prod1">
                                            ...
                                            <div style="width:49%;display: inline-block;">
                                                <label for="show_price" style="width:100%;margin:15px 0 5px;">Amount</label>
                                                <input type="text" name="emp_above_five_amount" id="emp_above_five_amount" class="form-control" value="<?php if(!empty($emp_above_five_amount)){ echo $emp_above_five_amount; } ?>">
                                            </div>
                                            <div style="width:49%;display: inline-block;">
                                                <label for="show_price" style="width:100%;margin:15px 0 5px;">Percentage</label>
                                                <input type="text" name="emp_above_five_percentage" id="emp_above_five_percentage" class="form-control" value="<?php if(!empty($emp_above_five_percentage)){ echo $emp_above_five_percentage; } ?>">
                                            </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="average" name="average" type="text"  class="form-control"
                                            placeholder="Enter Average" value="<?php if(!empty($average)){ echo $average; } ?>" />
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="min_amount" name="min_amount" type="text"  class="form-control"
                                            placeholder="Enter Min Amount" value="<?php if(!empty($min_amount)){ echo $min_amount; } ?>" />
                                </div>
                                   <!--  <div class="form-group">
