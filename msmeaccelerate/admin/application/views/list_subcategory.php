        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Sub Industry</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Sub Industry</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>subcategory/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Sub Industry</a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Sub Industry Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."subcategory/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <!--<td><?php echo $this->subcategory_model->get_group_name($result[$i]->group_id); ?>
                                                </td>  -->
                                                <td><?php echo $this->subcategory_model->get_category_name($result[$i]->industry_id); ?>
                                                </td>
                                                <td><?php echo $result[$i]->name; ?></td>
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."subcategory/edit/"; ?><?php echo $result[$i]->id; ?>">

                                                        <i class="fa fa-pencil"></i></a></td>
                                            </tr>
                                            <?php
                  } } else {
					  echo 'No Sub Sub Category Found';
				  }
...
function featured_product(id, value)
{
    if (value.checked)
    {
        var base_url = '<?php echo $base_url. 'subcategory/featured_product';?>';
...
function updateorder(val, id) {
    var t = confirm('Are you sure you want to Set order of Sub Category');
    if (t) {
        window.location.href = '<?php echo $base_url;?>subcategory/updateorder/' + id + '/' + val;
    } else {
        return false;
    }
}
