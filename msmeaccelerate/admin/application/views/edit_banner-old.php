                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    ...
                                    class="glyphicon glyphicon-lock"></span> Edit Banner</span> </div>
  ...
  ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    ...
                                    action="<?php echo $base_url;?>banner/edit/<?php echo $id; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="title1" name="title1" value="<?php echo $title1; ?>" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="title3" name="title3" type="text" class="form-control"
                                            ...
                                            placeholder="Enter Title 3" value="<?php echo $title3; ?>" />
                                   ...
                                   <!--  <div class="form-group">
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input id="web_image_alt_tag" name="web_image_alt_tag" type="text"
                                            ...
                                            class="form-control" placeholder="Enter Banner Image Alt Tag"

                                            value="<?php echo $web_image_alt_tag; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo $front_base_url; ?>upload/banner/<?php echo $mobile_image; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="mob_image_alt_tag" name="mob_image_alt_tag" type="text"
                                            ...
                                            value="<?php echo $mob_image_alt_tag; ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>banner/lists" class="submit btn bg-purple pull-right"
