        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Coverage</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Coverage</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>coverage/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Coverage</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Coverage Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."coverage/deletes";?>" method="post"
                                            ...
                                            <tr>
                                             ...
                                             <!--    <td>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."coverage/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'coverage/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>coverage/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'coverage/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of Coverage');

    if (t) {

        window.location.href = '<?php echo $base_url;?>coverage/updateorder/' + id + '/' + val;
