    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Add Product Home</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>product_home/lists">Product Home</a></li>
                    <li class="crumb-trail">Add a Product Home</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Add Product Home </span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>product_home/add"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="add_product_home">

                                    <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="title">Title</label>
                                        <input id="title" name="title" type="text" placeholder="Enter Title" class="form-control" value="" />
                                    </div>

                                     <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="url">Url</label>
                                        <input id="url" name="url" type="text" placeholder="Enter Url" class="form-control" value="" />
                                    </div>

                                    <div class="form-group">
                                        <label>Image (Size : 360px X 260)</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo $base_url;?>product_home/lists"
