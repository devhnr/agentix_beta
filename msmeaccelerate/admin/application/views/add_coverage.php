    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Add Coverage</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>coverage/lists">Coverage</a></li>
                    <li class="crumb-trail">Add a Coverage</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Add Coverage </span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>coverage/add"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo $base_url;?>coverage/lists"
