    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit Career </a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>career/lists">Career</a></li>
                    <li class="crumb-trail">Edit Career</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Edit Career</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>career/edit/<?php echo $id; ?>"
                                    ...
                                    <div class="form-group">
                                        <label style="width:100%; margin:15px 0 5px;" for="name">Title </label>
                                        <textarea id="title" name="title" type="text" class="form-control"
                                            placeholder="Enter Title" value=""><?php echo $title?></textarea>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>career/lists" class="submit btn bg-purple pull-right"
