    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);">Product Strength</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-trail">Product Strength</li>
                </ol>
            </div>
        </div>
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>product_strength/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Product Strength</a>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Product Strength Listing</span> </div>
                        <div class="panel-body">
                            <form action="<?php echo $base_url."product_strength/deletes";?>" method="post"
				...
				?>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $front_base_url; ?>upload/product_strength/small/<?php echo $result[$i]->image; ?>"
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."product_strength/edit/"; ?><?php echo $result[$i]->id; ?>">
					  ...
					  echo 'No Product Strength Found';
				  }
                ?>
...
$(document).ready(function($) {
    $('#reset').click(function() {
        var base_url = '<?php echo $base_url.'product_strength/lists'; ?>';
...
function updateorder(val, id) {
    var t = confirm('Are you sure you want to Set order of Product Strength');
    if (t) {
        window.location.href = '<?php echo $base_url;?>product_strength/updateorder/' + id + '/' + val;
    } else {
        return false;
    }
}
