  ...
  <section id="content_wrapper">
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          <li class="crumb-active"><a href="#">Users</a></li>
...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<a href="<?php echo $base_url;?>users/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Users</a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Users Listing </span> </div>
            <div class="panel-body">
              ...
              <div class="table-responsive">
				...
				<tr>
					...
					<td><?php echo $result[$i]->login; ?></td>					
					<td><?php echo $result[$i]->email; ?></td>
					<td><?php echo $result[$i]->created_by; ?></td>
					<td><?php echo $this->users_model->getrolename($result[$i]->role_id); ?></td>
					<td><?php 
				...
				?></td>
					...
					<td><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."users/edit/"; ?><?php echo $result[$i]->id; ?>">
