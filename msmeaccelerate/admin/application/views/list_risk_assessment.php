        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Risk Assessment</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Risk Assessment</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>risk_assessment/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Risk Assessment</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Risk Assessment Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."risk_assessment/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                              ...
                                              <!--   <td><img src="<?php echo $front_base_url.'/upload/category_home/large/'.$result[$i]->home_image;?>" width="50" height="50" /></td> -->
                                             ...
                                             <!--    <td>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."risk_assessment/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'risk_assessment/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>risk_assessment/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'risk_assessment/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of Risk Assessment');

    if (t) {

        window.location.href = '<?php echo $base_url;?>risk_assessment/updateorder/' + id + '/' + val;
