...
class Home_Model extends CI_Model 
{
  ...
  function sub_industry_profile() {
   ...
   function get_all_product($type_id,$coverage_id,$sub_industry_id)
   {
     $sql = "SELECT * FROM product WHERE type_id = '".$type_id."' and find_in_set ('".$coverage_id."', coverage_id) and sub_industry = '".$sub_industry_id."' ";
      $query = $this->db->query($sql);
  ...
  function product_covId($type_id,$coverage_id)
   ...
   function industry_add_more($p_id)
   {
      $sql = "SELECT * FROM industry_attribute WHERE p_id = '".$p_id."'";
      $query = $this->db->query($sql);
   ...
   function get_product_min_amount($id)
   {
   ...
   function get_industry_add_more_field($id){


      $sql= "select * from industry_attribute where p_id = ".$id." order by id desc";
