                            ...
                            <form class="cus-form-contain" id="inquiry_form" action="<?php echo $base_url;?>billship/inquiry_form_submit" method="post">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-12">
                                     ...
                                     <div class="col-lg-12">
                                        <input type="text" name="email_inquiry" id="email_inquiry" placeholder="Email ID">
                                    </div>
                                ...
                                <?php }?>
                                    ...
                                    <?php if($this->session->userdata('userid') == ''){ ?>
                                        <div class="col-lg-12 text-center margin-15px-top">   
                                         <button class="btn theme-btn-1 text-uppercase" id="otp_button" type="button" onclick="get_otp();">Get OTP </button>
                                        </div>
                                    <?php } ?>
