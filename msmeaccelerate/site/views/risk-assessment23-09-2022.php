     ...
     <section class="padding-55px-tb">
         ...
         <div class="container">
            ...
            <div class="text-center margin-15px-top">   
               ...
               <button class="btn theme-btn-1 text-uppercase" type="button" id="cuslog" onclick="showPremiumBreakup();">Get Premium Breakup 787</button>
                                   ...
                                   ?>
                                    ...
                                    <div class="coverage cov_Selected" id="mydiv_pc">
                                        ...
                                        <div class="coverage-name ">
                                            ...
                                            <p class="m-0 text-extra-dark-gray"><?php echo $product_detail->name?></p>
