      ...
      <body style="margin: 0 auto; font-family: 'Anek Latin', sans-serif;">
         ...
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#d2e9f1">
                                                 ...
                                                 <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="margin: -20px auto 0; padding: 20px">
                                                   ...
                                                   <tbody>
                                                        ...
                                                        <tr>
														 ...
														 $coverage_section = $this->session->userdata('coverage_new_array');
														 
														//$coverage_type = 'All';
														 
														 if($coverage_type != 'All'){
														 
														 foreach($coverage_section[$coverage_type] as $c_key => $c_value){
															 
															 //echo "<pre>";print_r($c_value);echo "</pre>";
															 
															 $net_premium_price = 0;
															 
															 $net_sum_insured_price = 0;
                                                         ...
                                                         <tr>
                                                            <td align="center" colspan="5" style="width:60%; background-color:#86b914; color:white; padding:10px 32px; text-transform: uppercase; border:none;font-family:'Helvetica',sans-serif; font-size:15pt; line-height:22pt; font-weight:600;"><?php echo $c_key;?>
															</td>
                                                         </tr>
                                                            ...
                                                            <td colspan="6" style="padding: 0px 50px 20px;font-family: 'Poppins', sans-serif;">
                                                              ...
                                                              <table>
																  ...
																  <tbody>
																	 ...
																	 <?php foreach($c_value as $type_key => $type_value){ 
																	 
																	 //echo "<pre>";print_r($type_value);echo "</pre>";
																	 
																	 
																	 
																	 if($type_value['products'] != ''){
																		 
																		 
																		 $count= 0;
																		 
																		 $total_sum_insured_product = 0;
																		 
																		 $total_price_product= 0;
																		 
																		 foreach($type_value['products'] as $product_key => $product_value){ 
																	 
																		//echo "<pre>";print_r($product_value);echo "</pre>";
																	 ...
																	 <tr>
																		 ...
																		 <td colspan="3"><?php echo $type_value['type_name'];?></td>
																	 ...
																	 <td><?php echo $product_value['product_name'];?></td>

																	 <td><?php echo $product_value['price'];?></td>

																		<td><?php echo $product_value['price_new'];?></td>                                 

																	 </tr>
																	 
																	 <?php $count++;
																	 
																	 $net_premium_price += round($product_value['price_new']);
																	 
																	 $net_sum_insured_price += round($product_value['price']);
																	 
																	 
																	 
																	 $total_sum_insured_product += round($product_value['price']);
																	 
																	 $total_price_product += round($product_value['price_new']);
																	 ...
																	 <td><?php echo $total_sum_insured_product;?></td>
																	 ...
																	 <?php
																		...
																		$gst_add_amount_premium = round($net_premium_price*18/100);
																		
																		$gst_add_amount_sum_insured = round($net_sum_insured_price*18/100);
																	 ...
																	 <td><?php echo $net_sum_insured_price?></td>

																		<td><?php echo $net_premium_price?></td>                                 
																	 ...
																	 <td><?php echo $gst_add_amount_sum_insured?></td>

																		<td><?php echo $gst_add_amount_premium?></td>                                 
																	 ...
																	 <td><?php echo $net_sum_insured_price + $gst_add_amount_sum_insured?></td>

																		<td><?php echo $net_premium_price + $gst_add_amount_premium?></td>                                 
														 ...
														 foreach($coverage_section as $c_key => $c_value){
															...
															$net_premium_price = 0;
															 ...
															 foreach($c_value as $cove_key => $cove_value){
															
															  //echo "<pre>";print_r($cove_value);echo "</pre>";
                                                         ...
                                                         <tr>
                                                            <td align="center" colspan="5" style="width:60%; background-color:#86b914; color:white; padding:10px 32px; text-transform: uppercase; border:none;font-family:'Helvetica',sans-serif; font-size:15pt; line-height:22pt; font-weight:600;"><?php echo $cove_key;?>
															</td>
                                                         </tr>
                              ...
                              <tbody>
								...
								foreach($cove_value as $pro_key =>$pro_value){
									
									//echo "<pre>";print_r($pro_value['products']);echo "</pre>";
									
									
								
								if (!empty($pro_value['products'])) {
									...
									foreach($pro_value['products'] as $product_key => $product_value){ 
								...
								<?php if($count == 0){ ?>
                                 ...
                                 <tr>
                                     ...
                                     <td colspan="3"><?php echo $pro_value['type_name'];?></td>
