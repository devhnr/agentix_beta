                  ...
                  ?>
                   ...
                   <?php $i++;} }?>
                    ...
                    foreach($all_type as $type_detail){ 
                      $get_product_detail = $this->home_model->get_all_product($type_detail->id,$coverage_detail->id);
                    ?>
                    <div class="cov"> 
                              ...
                              <div class="swiper-slide" id="remove_product">
                                 <div class="sub-pro">
                                  ...
                                  <?php }?>
                                    ...
                                    <div class="input_amt">
                                        <input class="cover-input" value="100000" id="cover_input">
                                    </div>
                                 </div>
                                  <!-- <div class="delete-btn" onclick="removeParent(this.value)"> -->
                                     <div class="delete-btn" onclick="sessionStore(this,<?php echo $product_detail->id?>);" >
...
<script>
  function sessionStore(elem,product_id) {
