                           ...
                           <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="res-center selected-element" style="text-align: center; color: #405060; font-family: 'Raleway', Arial, Sans-serif; font-size: 38px; letter-spacing: 0.7px; word-break: break-word; font-weight: bold; text-transform: uppercase;
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td class="res-center" style="text-align: justify; color: #506070; font-family: 'Open Sans', sans-serif;  font-size: 14px;  font-weight: 400; line-height: 1.8" data-color="M2 Subtitle 1" data-size="M2 Subtitle 1" data-max="24" data-min="5">
                                ...
                                <tr>
                                    ...
                                    <td height="53" style="font-size:0px">&nbsp;</td>
...
<?php
   ...
   $industry_add_more = $this->home_model->get_industry_add_more_field($industry_name->id);

   //echo "<pre>";print_r($industry_add_more);echo"</pre>";
   if($industry_add_more  != ''){
?>

<table bg-color="#f1f1f1" align="center" class="full selected-table" border="0" cellpadding="0" cellspacing="0" data-thumbnail="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/22/9jhlVUzudcB8NtbnMg67SvA5/StampReady/thumbnails/thumb-2.png" data-module="Module-2" data-bgcolor="M2 Bgcolor 1" >
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td class="res-center" style="text-align: left; color: #506070; font-family: 'Open Sans', Sans-serif; font-size: 14px;  font-weight: 400;" data-color="M2 Subtitle 1" data-size="M2 Subtitle 1" data-max="24" data-min="5">

                                        <ul>
                                          <?php foreach ($industry_add_more as $industry_add_more_data) {
                                             
                                             ?>
                                           <li style="margin-bottom: 12px; text-align: left; padding: 10px 25px; border: 1px solid #f1f1f1">
                                               <?php echo $industry_add_more_data->description;?>
                                               </li> 
                                            <?php } ?>
                                           <!-- <li style="margin-bottom: 12px; text-align: left ">totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi</li> 
                                           <li style="margin-bottom: 12px; text-align: left ">totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi</li> -->
