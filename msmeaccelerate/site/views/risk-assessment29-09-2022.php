               ...
               <div class="col-lg-9">
                 ...
                 <div class="graph-para">
                  ...
                  <div class="graph-contain">
                     ...
                     <div class="row margin-30px-top align-items-end">
                                  ...
                                  <?php }?>
                                    ...
                                    <div class="quantity">
                                       ...
                                       <?php 
                                        ...
                                        if($product_detail->show_price == 2){
                                    ...
                                    <div class="input_amt">
                                        ...
                                        <input class="cover-input" value="<?php echo $product_price;?>" id="cover_input">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="premium-flex box-shadow">
                                ...
                                <div class="premium-selected">
                                   ...
                                   ?>
                                    ...
                                    <div class="coverage cov_Selected" id="mydiv_pc">
                                        ...
                                        <div class="coverage-name ">
                                            ...
                                            <p class="m-0 text-extra-dark-gray"><?php echo $product_detail->name ." price ".$product_price." avg ".$product_detail->average;?></p>
                                  ...
                                  // $product_avg_percentage += $product_detail->average;

                                  if($type_detail->id == 3){
                                    //echo $product_price."dd";
                                    echo $product_price_new = $product_price * $this->session->userdata('no_of_emp') * $product_detail->average /100;
                                    //$total_premium = 0;

                                    $total_coverage_premium += $product_price_new; 
                                }else{
                                    $total_coverage_premium = 0;
                                    echo $product_price_new = $product_price;
                                    $total_coverage_premium += $product_price_new;
                                ...
                                echo"<pre>";print_r($product_price_new);echo"</pre>";
...
<script>
  ...
  function sessionStore(elem,product_id,coverage_id) {
    ...
    //alert(type_id);
    removeProduct(product_id,coverage_id);
 ...
 function removeProduct(product_id,coverage_id) {
    ...
    jQuery.ajax({
        ...
        data: 'product_id=' + product_id + '&coverage_id=' + coverage_id,
