            ...
            <div class="row">
               ...
               <div class="col-lg-3">
                   ...
                   <div class="v-dynamic-text bg-white box-shadow">
                        <div class="risk-pop-sec">
                            <a href="#modal-popup" class="modal-popup"><i class="feather icon-feather-external-link"></i> Read more</a>
                        </div>
                        
                       <div class="dy-heading text-center">

                        <h6 class="text-extra-dark-gray margin-15px-bottom font-weight-700">Risk Insights</h6>
						<?php $industry_name = $this->home_model->get_industry_name($this->session->userdata('industry_id'));?>

                        <h6 class="text-extra-dark-gray margin-15px-bottom "><?php echo $industry_name->name;?></h6>
...
foreach ($all_coverage as $coverage_detail) {
    $coverage_name = $coverage_detail->name;
    $coverage_id = $coverage_detail->id;
    ...
    foreach ($all_type as $type_detail) {
        ...
        $get_product_detail = $this->home_model->get_all_product(
            $type_id,
            $coverage_detail->id,
            $this->session->userdata('sub_industry_id')
        );

        $products = []; // To store product details (name and price) for this type and coverage

        foreach ($get_product_detail as $product_detail) {
			
			
            $products[] = [
                'product_name' => $product_detail->name, // Assuming product name field is 'product_name'
                'price' => $product_detail->price, // Assuming price field is 'price'
            ];
        }

        $type_array[] = [
            'type_name' => $type_name,
            'products' => $products // Adding the array of product details (name and price) to the type's subarray
        ];
    }

    $coverage_new_array[$coverage_id] = [
        $coverage_name => $type_array
    ];
}			 */	
					//echo"<pre>";print_r($coverage_new_array);echo"</pre>";
                        ...
                        <div class="service-flex">
                          ...
                          <?php if($type_detail->image !=''){?>
                           ...
                           <div class="service-icon">
                              ...
                              <img src="<?php echo $http_host?>upload/type_image/small/<?php echo $type_detail->image?>" alt="">
                         ...
                         <?php } else { ?>
                          ...
                          <div class="service-icon">
                              ...
                              <img src="<?php echo $http_host?>upload/type_image/small/noimage.jpg?>" alt="">
                              ...
                              <div class="swiper-slide" id="remove_product">
                                 ...
                                 <div class="sub-pro">
                                  ...
                                  <?php if($product_detail->image !=''){?>
                                    ...
                                    <img alt="" src="<?php echo $http_host?>upload/products/small/<?php echo $product_detail->image?>">

                                  <?php } else { ?>

                                    <img alt="" src="<?php echo $http_host?>upload/products/small/noimage.jpg">
                                  ...
                                  <?php }?>
                                    ...
                                    <div class="quantity">
                                       ...
                                       <?php 
										...
										$products[] = [
											'product_name' => $product_detail->name, // Assuming product name field is 'product_name'
											'price' => $product_price, // Assuming price field is 'price'
                                    ...
                                    <div class="input_amt">
                                        ...
                                        <input class="cover-input cover_input_<?php echo $product_detail->id?>" value="<?php echo $product_price;?>" id="cover_input" onkeyup="change_product_price('<?php echo $product_detail->id?>','<?php echo $coverage_detail->id?>','1',this.value);">
                ...
                <?php } } ?></div> <?php $h++;
					...
					$coverage_new_array[$coverage_id] = [$coverage_name => $type_array];
				} 
				
				
				$this->session->set_userdata('coverage_new_array',$coverage_new_array);
  ...
  <div class="bg-extra-light-gray margin-60px-tb h-2px"></div>
      ...
      <section class="padding-55px-tb" id="premiumBreakup" style="display:none">
      ...
      <?php
           ...
           foreach($all_coverage as $coverage_details){
			...
			$coverage_name = $coverage_details->name;
                                   ...
                                   ?>
                                    ...
                                    <div class="coverage cov_Selected" id="mydiv_pc">
                                        ...
                                        <div class="coverage-name ">
                                            ...
                                            <p class="m-0 text-extra-dark-gray"><?php echo $product_detail->name." <br><span class='rupee-icon'><i class='fas fa-rupee-sign'> </i></span>".number_format($product_price_new);?></p>
                              ...
                              ?>
                                    ...
                                    <div class="coverage-premium text-center">  
                                            ...
                                            <div class="coverage-amount text-center">
                                                ...
                                                <p class="text-extra-dark-gray m-0 font-weight-700"><span class="rupee-icon"><i class="fas fa-rupee-sign"> </i></span><span class="amount text-blue1"><?php echo number_format($total_coverage_premium) ;?></span><span class="tenure">/year</span> </p>
                                ...
                                <div class="full-premium-box bg-white box-shadow padding-20px-tb padding-30px-lr">  
                                    ...
                                    <div class="row align-items-center justify-content-center">
                                            ...
                                            <div class="tbl_flex">
                                                    ...
                                                    <p class="m-0 text-extra-dark-gray m-0 font-weight-600"> <span class="rupee-icon"><i class="fas fa-rupee-sign"> </i></span><?php echo number_format($total_premium);?>/-</p>
                                            ...
                                            <div class="tbl_flex">
                                                    ...
                                                    <p class="m-0 text-extra-dark-gray m-0 font-weight-600"> <span class="rupee-icon"><i class="fas fa-rupee-sign"> </i></span><?php echo number_format($gst_add_amount);?>/-</p>
                                            ...
                                            <div class="tbl_flex total_sec">
                                                    ...
                                                    <p class="m-0 text-blue2 m-0 font-weight-600"> <span class="rupee-icon"><i class="fas fa-rupee-sign"> </i></span><span> <?php echo number_format($last_final_premium);?></span><span class="tenure">/year</span> </p>
                                    ...
                                    <div class="row text-center justify-content-center margin-two-top">
                                        ...
                                        <a class="btn theme-btn-1 text-uppercase" id="cuslog" onclick="process_to_inquiry('<?php echo $coverage_details->id?>');">Talk to Expert >></a>

                                        <a class="btn theme-btn-1 text-uppercase" id="cuslog" style="margin: 0 0 0 15px;" onclick="open_mailpopup();">Send Mail</a>
...
<div class="modal fade" id="send_mail_popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-notify modal-warning" role="document">
    <!--Content-->
    <div class="modal-content">
	<form class="cus-form-contain" id="popupmail_form" action="<?php echo $base_url;?>home/send_mail_popup" method="post">
      <!--Header-->
      <div class="modal-header text-center">
        <h4 class="modal-title white-text w-100 font-weight-bold py-2">Send Mail</h4>
      ...
      <div class="modal-body">
        <div class="md-form ">
		  <label data-error="wrong" data-success="right" for="form3">Select Coverage</label>
          <select class="type_coverage" name="type_coverage" id="type_coverage">
			<option value="">Select Coverage</option>
			<?php foreach($all_coverage as $coverage_details){?>
			<option value="<?php echo $coverage_details->id;?>"><?php echo $coverage_details->name;?></option>
			<?php } ?>
		...
		<span id="popupmail_error" class="error alert-message valierror " style="display: none;"></span>
        <span id="popupmail_success" class="successmain alert-message" style="display:none;"></span>
							
      </div>

      <!--Footer-->
      <div class="modal-footer justify-content-center">
        <a type="button" class="btn theme-btn-1 text-uppercase" onclick="popup_validation();">Send <i class="fas fa-paper-plane-o ml-1"></i></a>
      </div>
	  </form>
    </div>
    <!--/.Content-->
	  ...
	  function popup_validation(){
		...
		var type_coverage = jQuery("#type_coverage").val();
		if (type_coverage == '') {
			// alert('Please enter Agent ID');
			jQuery('#popupmail_error').html("Please Select Coverage");
			jQuery('#popupmail_error').show().delay(0).fadeIn('show');
			jQuery('#popupmail_error').show().delay(2000).fadeOut('show');
			return false;
		}
		...
		if (email == '') {
			...
			//alert("name");
			jQuery('#popupmail_error').html("Please Enter Email");
			jQuery('#popupmail_error').show().delay(0).fadeIn('show');
			jQuery('#popupmail_error').show().delay(2000).fadeOut('show');
			return false;
		}
		...
		if (!filter.test(em)) {
			jQuery('#popupmail_error').html("Please Enter Valid Email");
			jQuery('#popupmail_error').show().delay(0).fadeIn('show');
			jQuery('#popupmail_error').show().delay(2000).fadeOut('show');
			return false;
		}
		
		$('#popupmail_form').submit();
...
function showPremiumBreakup() {
   ...
   var x = document.getElementById("premiumBreakup");
...
<script>
  ...
  function sessionStore(elem,product_id,coverage_id) {
	  ...
	  var t = confirm('Based on your risk profile, we recommend you to keep this product. Do you want to delete the product?');
...
$('.cover_input_<?php echo $product_detail->id?>').keydown(function(e) {
   setTimeout(() => {
    let parts = $(".cover_input_<?php echo $product_detail->id?>").val().split(".");
    ...
    $(".cover_input_<?php echo $product_detail->id?>").val(n);
  })
})
$( document ).ready(function() {
setTimeout(() => {
...
function open_mailpopup(){
	
	$('#send_mail_popup').modal('show');
...
<?php 
               $industry_add_more = $this->home_model->industry_add_more($this->session->userdata('industry_id'));
               if($industry_add_more != ''){?>
<div id="modal-popup" class="col-11 col-xl-10 col-lg-10 col-md-8 col-sm-9 position-relative mx-auto bg-white  modal-popup-main p-0 border-radius-6px mfp-hide">
                            <div class="risk-modal-head">
                                <h6 class="text-white font-weight-600">Risk Insights</h6>
                            </div>
                      ...
                      ?>
                                <div class="risk-desc position-relative">
									  <span class="p-line"></span>
									<div class="risk-cont">
										<div class="risk-img">
											<img src="<?php echo $front_base_url;?>upload/industry_add_more/<?php echo $industry_add_more_data->s_image?>" alt="">
										</div>
										<div class="risk-heading">
											<h6 class="alt-font text-extra-dark-gray m-0"><?php echo $industry_add_more_data->title?></h6>
											<p class="text-extra-dark-gray p-0">                                                                           											
                                        <?php echo $industry_add_more_data->description?>
                                       </p>
										</div>
