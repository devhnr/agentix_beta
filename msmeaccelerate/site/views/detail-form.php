                        ...
                        <div class="col-lg-12 padding-25px-tb padding-25px-lr">
                            ...
                            <form class="cus-form-contain" method="post" role="form" id="contact-form" novalidate="true">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" name="annual_turnover" id="annual_turnover" placeholder="Estimated Annual Turnover" oninput="process(this)">
                                    </div>

                                     <div class="col-lg-12">
                                        <input type="text" name="asses_value" id="asses_value" placeholder="Estimated Asset Value" oninput="process(this)">
                                    </div>
                                    <div class="col-lg-12">
                                        <input type="text" name="no_of_emp" id="no_of_emp" placeholder="Number of Employee"  oninput="process(this)">
                                    </div>
                                   <!--  <div class="col-lg-12">
...
function detail_form() {
    ...
    //alert('<?php $this->session->userdata('userid') ?>');

    if('<?php echo $this->session->userdata('userid') ?>'  == ''){
        

        if(annual_turnover > 1000000000){
            jQuery('#contact_error').html("Maximum limit for annual turnover is 100 Cr");
            jQuery('#contact_error').show().delay(0).fadeIn('show');
            jQuery('#contact_error').show().delay(2000).fadeOut('show');
            return false;
        }
    ...
    if (asses_value == '') {
        ...
        //alert ('message alert');
        jQuery('#contact_error').html("Plesae Enter Estimated Assets Value");
        jQuery('#contact_error').show().delay(0).fadeIn('show');
        jQuery('#contact_error').show().delay(2000).fadeOut('show');
        return false;
    }
    ...
    jQuery.ajax({
        url: url,
        type: 'post',
        data: '&company=' + company + '&industry_id=' + industry_id + '&sub_industry_id=' + sub_industry_id + '&annual_turnover=' + annual_turnover + '&asses_value=' + asses_value + '&no_of_emp=' + no_of_emp + '&check1=' + check1 + '&email=' + email,
